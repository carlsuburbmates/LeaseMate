...
const RUN_LIVE_RESEND_TESTS = process.env.RUN_LIVE_RESEND_TESTS === "1";
const resendIt = RUN_LIVE_RESEND_TESTS ? it : it.skip;

describe("Resend API key validation", () => {
  resendIt("should have a valid RESEND_API_KEY that authenticates with Resend", async () => {
